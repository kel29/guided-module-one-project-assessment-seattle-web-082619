...
class CrazyEightGame < ActiveRecord::Base
    ...
    def draw_card(player_id)
        ...
        new_card = Hand.create(location: player_id[:player_id], deck_id: deck_id, suit: new_card_hash['cards'][0]['suit'], value: new_card_hash['cards'][0]['value'], code: new_card_hash['cards'][0]['code'])
